...
@implementation MessageViewLayout

-(id)initWithView:(UIView *)view {
    self = [super init];
    if (self) {
        // NSLog(@"initmessagelayout");
...
#pragma mark - UIMessageViewLayout
-(void)prepareLayout {
...
-(void)doNewLayout {
    id<UIMessageViewLayoutDelegate> delegate = (id<UIMessageViewLayoutDelegate>)self.collectionView.delegate;
