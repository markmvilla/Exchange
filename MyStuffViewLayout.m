...
@implementation MyStuffViewLayout
...
#pragma mark - UIMyStuffViewLayout
- (void)prepareLayout {
...
- (void)doNewLayout {
    id<UIMyStuffViewLayoutDelegate> delegate = (id<UIMyStuffViewLayoutDelegate>)self.collectionView.delegate;
